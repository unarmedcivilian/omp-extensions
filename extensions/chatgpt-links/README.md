...
- `chatgpt_import_conversation` opens a ChatGPT conversation URL or bare conversation id in cmux browser via the Unix socket API with CLI fallback, waits for the page to load, extracts `body` text, and saves it to disk.
